...
const todoText =
  'Полностью функцианальное приложение ToDo. Можно добавлять/удалять задачи, создавать таймер обратного отсчета для отслеживания времени выполнения.'
const cinemaText =
...
const aviaText =
  'Тестовое задание для Front-end разработчиков на React в компани AviaSales. С сервера поступают пакеты с билетами (около 10000 шт.). Сортировка и фильтрация функциональны.'
const blogText =
  'Функцианальная Блог платформа. Есть возможность регистрации/авторизации, создание/редактирование статей (статьи создаются в Marckdown), редактирование профиля, оценка статей других людей. Приложение работает с реальным API.'
