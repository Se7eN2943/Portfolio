      ...
      <div className={s.main_aboutMe}>
        ...
        <div className={s.main_aboutMe__text}>
          ...
          <p>
            ...
            опыт чтения чужого кода и его рефакторинга. Так же работал с Git
            Lab. Создавал страницы личного кабинет для проекта TeamUp
            (приложение для поиска и размещения мероприятий, на данный момент
            находится в разработке), а так же дорабатывал и рефакторил другие
            страницы и компоненты этого приложения. Передавал знания и описывал
            текущее состояние проекта новым разработчикам. Примеры моих работ
            можно посмотреть ниже. Так как я начинающий разработчик, у меня нет
            коммерческого опыта разработки. Хочу развиваться, и закреплять
            опытом свои знания и умения в разработке. В будущем хочу развиться
            до full-stack разработчика.
          </p>
        </div>
