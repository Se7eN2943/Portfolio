...
const TicketList = () => {
  ...
  const { sortFlag, sliced, tickets, filterList } = useSelector((state) => state.aviaSalesReducer)
    ...
    <>
      {elements.length === 0
        ...
        <>
          ...
          <button onClick={() => dispatch(SLICED(sliced + 5))} className="allTicketsBtn active">
